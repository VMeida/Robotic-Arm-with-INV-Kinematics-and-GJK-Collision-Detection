...
function [T0_0 T1_0 T2_0 T3_0 T4_0 T5_0 T6_0] = forwardKinematics2(theta)
...
alpha_0 = 0;
d_0 = 0;
T0_0 = getTi_i_1(a_0, alpha_0, d_0, 0);

a_1 = l2;
alpha_1 = -90;
d_1 = l1;
T1_0 = getTi_i_1(a_1, alpha_1, d_1, theta(1)+180);
T1_0 = T0_0 * T1_0;
